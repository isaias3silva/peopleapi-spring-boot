...
import br.com.dio.personapi.controller.PersonController;
...
import static br.com.dio.personapi.utils.PersonUtils.asJsonString;
...
public class PersonControllerTest {
    ...
    void testWhenGETWithInvalidIsCalledThenAnErrorMessagenShouldBeReturned() throws Exception {
        ...
        when(personService.findById(expectedValidId)).thenThrow(PersonNotFoundExceptions.class);
    ...
    void testWhenGETIsCalledThenPeopleListShouldBeReturned() throws Exception {
        ...
        when(personService.lisAll()).thenReturn(expectedPeopleDTOList);
